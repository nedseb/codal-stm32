...
class VL53L0X_Distance : public VL53L0X, public Sensor {
    public:
        VL53L0X_Distance( uint8_t id, STM32I2C& i2c, STM32Pin& shutPin, uint8_t address, uint16_t sensitivity = SENSOR_DEFAULT_SENSITIVITY, uint16_t samplePeriod = SENSOR_DEFAULT_SAMPLE_PERIOD );
