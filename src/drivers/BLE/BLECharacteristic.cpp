...
BLECharacteristic::BLECharacteristic() : BLECharacteristic((BLELocalCharacteristic*)NULL) {}

BLECharacteristic::BLECharacteristic(BLELocalCharacteristic* local) : _local(local), _remote(NULL)
{
    if (_local) {
        _local->retain();
    }
...
BLECharacteristic::BLECharacteristic(BLERemoteCharacteristic* remote) : _local(NULL), _remote(remote)
{
    if (_remote) {
        _remote->retain();
    }
