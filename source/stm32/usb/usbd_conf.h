...
extern "C" {
        ...
        #include <string.h>
            ...
            #if defined(STM32F1xx) || defined(STM32F3xx) || defined(STM32G4xx) || defined(STM32L1xx) || \
                defined(STM32WBxx)
        ...
        /* MSC Class Config */
            ...
            #define MSC_MEDIA_PACKET 8'192U
        #endif /* MSC_MEDIA_PACKET */

        /* CDC Class Config */
        #ifndef USBD_CDC_INTERVAL
            #define USBD_CDC_INTERVAL 2'000U
        ...
        /* DFU Class Config */
            ...
            #define USBD_DFU_XFERS_IZE 1'024U
        #endif /* USBD_DFU_XFERS_IZE */

        /* AUDIO Class Config */
        #ifndef USBD_AUDIO_FREQ
            #define USBD_AUDIO_FREQ 22'100U
