...
#elif STM32G0xx
    #include "stm32g0xx_hal_wwdg.c"
#elif STM32G4xx
    #include "stm32g4xx_hal_wwdg.c"
#elif STM32H5xx
    #include "stm32h5xx_hal_wwdg.c"
#elif STM32H7xx
...
#elif STM32WBAxx
    #include "stm32wbaxx_hal_wwdg.c"
#elif STM32WLxx
    #include "stm32wlxx_hal_wwdg.c"
#endif
