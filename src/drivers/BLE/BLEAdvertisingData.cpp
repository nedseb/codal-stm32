...
bool BLEAdvertisingData::setManufacturerData(const uint16_t companyId, const uint8_t manufacturerData[],
                                             int manufacturerDataLength)
{
    ...
    bool success =
        updateRemainingLength(previousLength, (manufacturerDataLength + sizeof(companyId) + AD_FIELD_OVERHEAD));
    if (success) {
        _manufacturerData         = manufacturerData;
        _manufacturerDataLength   = manufacturerDataLength;
...
bool BLEAdvertisingData::addManufacturerData(const uint16_t companyId, const uint8_t manufacturerData[],
                                             int manufacturerDataLength)
{
