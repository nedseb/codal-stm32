...
int HCISpiTransportClass::available()
{
    ...
    if (_read_index != _write_index) {
        ...
        while (digitalRead(_spi_irq) == 1 && _write_index != BLE_MODULE_SPI_BUFFER_SIZE) {
            ...
            /* Write the header */
            _spi->transfer(header_master, 5, header_master, 5);
                    ...
                    if (byte_count > 0) {
                        if (_initial_phase) {
                            ...
                            for (int j = 0; j < byte_count; j++) {
                                uint8_t buf = 0xFF;
                                _spi->transfer(&buf, 1, &buf, 1);
                                _rxbuff[_write_index_initial] = buf;
                            ...
                            if (byte_count > (BLE_MODULE_SPI_BUFFER_SIZE - _write_index)) {
                                ...
                                /* SPI buffer is full but we still have data to store, so we set the data_avail flag to
                                 * true */
                                data_avail = 1;
                            }
        ...
        if (_ble_chip == SPBTLE_RF || _ble_chip == BLUENRG_M0) {
            ...
            if (header_master[0] == 0x02) {
                if (header_master[1] >= length) {
                    /* Write the data */
                    _spi->transfer((uint8_t*)my_data, length, (uint8_t*)my_data, length);
                }
                else {
                    result = -2;
                }
                ...
                if (header_master[0] == 0x02) {
                    ...
                    if (byte_count > 0) {
                        ...
                        if (byte_count == 6) {
                            ...
                            if (event[0] == 0x04 && event[1] == 0xFF && event[2] == 0x03 && event[3] == 0x01 &&
                                event[4] == 0x00 && event[5] == 0x01) {
            ...
            if (_ble_chip == SPBTLE_RF || _ble_chip == BLUENRG_M0) {
                ...
                if (header_master[0] == 0x02) {
                    ...
                    if (byte_count > 0) {
                        ...
                        if (byte_count >= 7) {
                            if (data[0] == 0x04 && data[1] == 0x0E && data[2] == 0x04 && data[3] == 0x01 &&
                                data[4] == 0x0C && data[5] == 0xFC && data[6] == 0x00) {
                                status = 1;
                            }
                        }
                    }
            ...
            if (_ble_chip == SPBTLE_RF || _ble_chip == BLUENRG_M0) {
                ...
                if (header_master[0] == 0x02) {
                    ...
                    if (byte_count > 0) {
                        ...
                        if (byte_count >= 7) {
                            if (data[0] == 0x04 && data[1] == 0x0E && data[2] == 0x04 && data[3] == 0x01 &&
                                data[4] == 0x01 && data[5] == 0xFD && data[6] == 0x00) {
                                status = 1;
                            }
                        }
                    }
            ...
            if (_ble_chip == SPBTLE_RF || _ble_chip == BLUENRG_M0) {
                ...
                if (header_master[0] == 0x02) {
                    ...
                    if (byte_count > 0) {
                        ...
                        if (byte_count >= 13) {
                            if (data[0] == 0x04 && data[1] == 0x0E && data[2] == 0x0A && data[3] == 0x01 &&
                                data[4] == 0x8A && data[5] == 0xFC && data[6] == 0x00) {
                                status = 1;
                            }
                        }
                    }
            ...
            if (_ble_chip == SPBTLE_RF || _ble_chip == BLUENRG_M0) {
                ...
                if (header_master[0] == 0x02) {
                    ...
                    if (byte_count > 0) {
                        ...
                        if (byte_count >= 13) {
                            if (data[0] == 0x04 && data[1] == 0x0E && data[2] == 0x0A && data[3] == 0x01 &&
                                data[4] == 0x0D && data[5] == 0xFC && data[6] == 0x00) {
                ...
                if (byte_count > 0) {
                    ...
                    if (byte_count >= 14) {
                        if (data[0] == 0x04 && data[1] == 0x0E && data[2] == 0x0B && data[3] == 0x01 &&
                            data[4] == 0x0D && data[5] == 0xFC && data[6] == 0x00) {
