...
/* Exported typedef ----------------------------------------------------------*/
typedef enum { ES_WIFI_INIT = 0, ES_WIFI_RESET = 1 } ES_WIFI_InitMode_t;
...
typedef struct {
    ...
    ES_WIFI_SecurityType_t
        Security;    /*!< Security of Wi-Fi spot. This parameter can be a value of \ref ESP8266_Ecn_t enumeration */
