...
BLEDescriptor::BLEDescriptor() : BLEDescriptor((BLELocalDescriptor*)NULL) {}

BLEDescriptor::BLEDescriptor(BLELocalDescriptor* local) : _local(local), _remote(NULL)
{
    if (_local) {
        _local->retain();
    }
...
BLEDescriptor::BLEDescriptor(BLERemoteDescriptor* remote) : _local(NULL), _remote(remote)
{
    if (_remote) {
        _remote->retain();
    }
...
BLEDescriptor::BLEDescriptor(const char* uuid, const char* value) : BLEDescriptor(new BLELocalDescriptor(uuid, value))
{
}
