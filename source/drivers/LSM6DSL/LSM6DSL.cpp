...
LSM6DSL::LSM6DSL( STM32I2C& i2c, uint8_t address ) : i2c(i2c), address(address), isGyroscopeEnable(false), isAccelerometerEnable(false) {
}

void LSM6DSL::init( LSM6DSL_ACC_GYRO_ODR_G_t gyroscopeOutputDataRate, LSM6DSL_ACC_GYRO_ODR_XL_t accelerometerOutputDataRate,
                    LSM6DSL_ACC_GYRO_FS_G_t gyroscopeFullscale, LSM6DSL_ACC_GYRO_FS_XL_t accelerometerFullscale){
