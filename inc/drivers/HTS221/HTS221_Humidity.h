...
class HTS221_Humidity : public HTS221, public Sensor {
    public:
        HTS221_Humidity( uint8_t id, STM32I2C& i2c, uint16_t address, uint16_t sensitivity = SENSOR_DEFAULT_SENSITIVITY, uint16_t samplePeriod = SENSOR_DEFAULT_SAMPLE_PERIOD );
