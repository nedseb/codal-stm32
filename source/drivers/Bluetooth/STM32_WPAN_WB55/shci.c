...
SHCI_CmdStatus_t SHCI_C2_FUS_UpdateAuthKey(SHCI_C2_FUS_UpdateAuthKey_Cmd_Param_t* pParam)
{
    ...
    shci_send(SHCI_OPCODE_C2_FUS_UPDATE_AUTH_KEY, sizeof(SHCI_C2_FUS_UpdateAuthKey_Cmd_Param_t), (uint8_t*)pParam,
              p_rsp);
...
SHCI_CmdStatus_t SHCI_C2_FUS_StoreUsrKey(SHCI_C2_FUS_StoreUsrKey_Cmd_Param_t* pParam, uint8_t* p_key_index)
{
    ...
    shci_send(SHCI_OPCODE_C2_FUS_STORE_USR_KEY, local_payload_len, (uint8_t*)pParam, p_rsp);
...
SHCI_CmdStatus_t SHCI_C2_BLE_Init(SHCI_C2_Ble_Init_Cmd_Packet_t* pCmdPacket)
{
    ...
    shci_send(SHCI_OPCODE_C2_BLE_INIT, sizeof(SHCI_C2_Ble_Init_Cmd_Param_t), (uint8_t*)&pCmdPacket->Param, p_rsp);
...
SHCI_CmdStatus_t SHCI_C2_THREAD_Init(void)
{
    ...
    shci_send(SHCI_OPCODE_C2_THREAD_INIT, 0, 0, p_rsp);
...
SHCI_CmdStatus_t SHCI_C2_LLDTESTS_Init(uint8_t param_size, uint8_t* p_param)
{
    ...
    shci_send(SHCI_OPCODE_C2_LLD_TESTS_INIT, param_size, p_param, p_rsp);
...
SHCI_CmdStatus_t SHCI_C2_BLE_LLD_Init(uint8_t param_size, uint8_t* p_param)
{
    ...
    shci_send(SHCI_OPCODE_C2_BLE_LLD_INIT, param_size, p_param, p_rsp);
...
SHCI_CmdStatus_t SHCI_C2_DEBUG_Init(SHCI_C2_DEBUG_Init_Cmd_Packet_t* pCmdPacket)
{
    ...
    shci_send(SHCI_OPCODE_C2_DEBUG_INIT, sizeof(SHCI_C2_DEBUG_init_Cmd_Param_t), (uint8_t*)&pCmdPacket->Param, p_rsp);
...
SHCI_CmdStatus_t SHCI_C2_CONCURRENT_GetNextBleEvtTime(SHCI_C2_CONCURRENT_GetNextBleEvtTime_Param_t* pParam)
{
    ...
    memcpy((void*)&(pParam->relative_time), (void*)&((TL_CcEvt_t*)(p_rsp->evtserial.evt.payload))->payload[1],
           sizeof(pParam->relative_time));
...
SHCI_CmdStatus_t SHCI_C2_CONCURRENT_EnableNext_802154_EvtNotification(void)
{
    ...
    shci_send(SHCI_OPCODE_C2_CONCURRENT_ENABLE_NEXT_802154_EVT_NOTIFICATION, 0, 0, p_rsp);
...
SHCI_CmdStatus_t SHCI_C2_MAC_802_15_4_Init(void)
{
    ...
    shci_send(SHCI_OPCODE_C2_MAC_802_15_4_INIT, 0, 0, p_rsp);
...
SHCI_CmdStatus_t SHCI_C2_ExtpaConfig(uint32_t gpio_port, uint16_t gpio_pin_number, uint8_t gpio_polarity,
                                     uint8_t gpio_status)
{
    /**
     * TL_BLEEVT_CC_BUFFER_SIZE is 16 bytes so it is large enough to hold the 8 bytes of command parameters
...
SHCI_CmdStatus_t SHCI_C2_Config(SHCI_C2_CONFIG_Cmd_Param_t* pCmdPacket)
{
    ...
    shci_send(SHCI_OPCODE_C2_CONFIG, sizeof(SHCI_C2_CONFIG_Cmd_Param_t), (uint8_t*)pCmdPacket, p_rsp);
...
SHCI_CmdStatus_t SHCI_C2_802_15_4_DeInit(void)
{
    ...
    shci_send(SHCI_OPCODE_C2_802_15_4_DEINIT, 0, 0, p_rsp);
