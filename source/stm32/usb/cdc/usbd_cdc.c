...
__ALIGN_BEGIN static uint8_t USBD_CDC_CfgFSDesc[USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END = {
    ...
    0x09,                        /* bLength: Configuration Descriptor size */
    USB_DESC_TYPE_CONFIGURATION, /* bDescriptorType: Configuration */
    USB_CDC_CONFIG_DESC_SIZ,     /* wTotalLength: nb of returned bytes */
    0x00, 0x02,                  /* bNumInterfaces: 2 interfaces */
    0x01,                        /* bConfigurationValue: Configuration value */
...
__ALIGN_BEGIN static uint8_t USBD_CDC_OtherSpeedCfgDesc[USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END = {
    0x09, /* bLength: Configuration Descriptor size */
    USB_DESC_TYPE_OTHER_SPEED_CONFIGURATION, USB_CDC_CONFIG_DESC_SIZ, 0x00, 0x02, /* bNumInterfaces: 2 interfaces */
...
static uint8_t* USBD_CDC_GetFSCfgDesc(uint16_t* length)
{
    USBD_EpDescTypeDef* pEpCmdDesc = USBD_GetEpDesc(USBD_CDC_CfgFSDesc, CDC_CMD_EP);
    USBD_EpDescTypeDef* pEpOutDesc = USBD_GetEpDesc(USBD_CDC_CfgFSDesc, CDC_OUT_EP);
    USBD_EpDescTypeDef* pEpInDesc  = USBD_GetEpDesc(USBD_CDC_CfgFSDesc, CDC_IN_EP);
...
static uint8_t* USBD_CDC_GetHSCfgDesc(uint16_t* length)
{
    USBD_EpDescTypeDef* pEpCmdDesc = USBD_GetEpDesc(USBD_CDC_CfgHSDesc, CDC_CMD_EP);
    USBD_EpDescTypeDef* pEpOutDesc = USBD_GetEpDesc(USBD_CDC_CfgHSDesc, CDC_OUT_EP);
    USBD_EpDescTypeDef* pEpInDesc  = USBD_GetEpDesc(USBD_CDC_CfgHSDesc, CDC_IN_EP);
...
static uint8_t* USBD_CDC_GetOtherSpeedCfgDesc(uint16_t* length)
{
    USBD_EpDescTypeDef* pEpCmdDesc = USBD_GetEpDesc(USBD_CDC_OtherSpeedCfgDesc, CDC_CMD_EP);
    USBD_EpDescTypeDef* pEpOutDesc = USBD_GetEpDesc(USBD_CDC_OtherSpeedCfgDesc, CDC_OUT_EP);
    USBD_EpDescTypeDef* pEpInDesc  = USBD_GetEpDesc(USBD_CDC_OtherSpeedCfgDesc, CDC_IN_EP);
