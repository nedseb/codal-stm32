...
class ATTClass {
  public:
    ...
    virtual void addConnection(uint16_t handle, uint8_t role, uint8_t peerBdaddrType, uint8_t peerBdaddr[6],
    ...
    virtual int writeReq(uint16_t connectionHandle, uint16_t handle, const uint8_t* data, uint8_t dataLen,
  ...
  private:
    ...
    virtual int findInfoReq(uint16_t connectionHandle, uint16_t startHandle, uint16_t endHandle,
                            uint8_t responseBuffer[]);
    ...
    virtual int readByTypeReq(uint16_t connectionHandle, uint16_t startHandle, uint16_t endHandle, uint16_t type,
                              uint8_t responseBuffer[]);
    virtual void readByTypeResp(uint16_t connectionHandle, uint8_t dlen, uint8_t data[]);
    virtual void readOrReadBlobReq(uint16_t connectionHandle, uint16_t mtu, uint8_t opcode, uint8_t dlen,
                                   uint8_t data[]);
    ...
    virtual int readByGroupReq(uint16_t connectionHandle, uint16_t startHandle, uint16_t endHandle, uint16_t uuid,
                               uint8_t responseBuffer[]);
